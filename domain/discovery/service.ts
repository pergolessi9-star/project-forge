...
const stages=["INTAKE","PROBLEM","MARKET","TECHNOLOGY","REGULATION","EVIDENCE","CONCEPT","MVP","VALIDATION","SPECIFICATION"] as const;
const statuses=["DISCOVERY","DISCOVERY","DISCOVERY","DISCOVERY","DISCOVERY","DISCOVERY","CONCEPT","MVP","VALIDATION","SPECIFICATION"] as const;
